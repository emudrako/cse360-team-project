...
public class ViewStaffCoverage{
	...
	private static Scene theViewStaffFeedbackScene;
	...
	public static void displayStaffCoverage(Stage ps, User user) {
		...
		theStage.setTitle("CSE 360 Foundations: Staff Feedback Page");
		theStage.setScene(theViewStaffFeedbackScene);
		theStage.show();
	}
	...
	private ViewStaffCoverage() {
		...
		theViewStaffFeedbackScene = new Scene(theRootPane, width, height);

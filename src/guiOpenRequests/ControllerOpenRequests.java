...
/*******
 * <p> Title: ControllerOpenRequests Class. </p>
 *
 * <p> Description: The Java/FX-based Open Requests Page controller. Handles button actions
 * defined by ViewOpenRequests. This page is a placeholder; actions for viewing open
 * requests, closing requests with admin notes, and reopening requests will be added in a
 * future phase.
 *
...
public class ControllerOpenRequests {
	...
	protected static void performLogout() {
		guiUserLogin.ViewUserLogin.displayUserLogin(ViewOpenRequests.theStage);
	}

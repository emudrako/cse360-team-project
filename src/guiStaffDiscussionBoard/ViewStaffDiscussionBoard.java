...
import guiStaffDiscussionBoard.ControllerStaffDiscussionBoard;
...
public class ViewStaffDiscussionBoard{
	...
	private ViewStaffDiscussionBoard() {
		...
		// Home Button Style, takes user to staff home
		setupButtonUI(button_Return, "Dialog", 12, 70, Pos.CENTER, 880, 10);
	    button_Return.setOnAction((_) -> { ControllerStaffDiscussionBoard.performReturn(); });

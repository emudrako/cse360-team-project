 ...
 *
 * <p> Description: The Java/FX-based Manage Parameters Page. Allows staff to create,
 * update, and delete evaluation parameters used to assess student discussion performance.
...
public class ViewManageParameters {
	...
	private static ViewManageParameters theView;
	...
	private static Scene theViewManageParametersScene;
	 ...
	 *
	 * <p> Description: Single entry point to display the Manage Parameters page. </p>
	 *
	...
	public static void displayManageParameters(Stage ps, User user) {
		...
		theStage.setTitle("CSE 360 Foundations: Manage Parameters Page");
		theStage.setScene(theViewManageParametersScene);
		theStage.show();
	}
	 ...
	 *
	 */
	private ViewManageParameters() {
		theRootPane = new Pane();
		theViewManageParametersScene = new Scene(theRootPane, width, height);
		...
		button_Logout.setOnAction((_) -> { ControllerManageParameters.performLogout(); });

		setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 300, 540);
		button_Quit.setOnAction((_) -> { ControllerManageParameters.performQuit(); });

...
public class ViewStaffRequests{
	...
	private static Scene theViewStaffRequestsScene;
	...
	public static void displayStaffRequests(Stage ps, User user) {
		...
		theStage.setScene(theViewStaffRequestsScene);
		theStage.show();
	}
	...
	private ViewStaffRequests() {
		...
		theViewStaffRequestsScene = new Scene(theRootPane, width, height);
	    ...
	    button_Return.setOnAction((_) -> { ControllerStaffRequests.performReturn(); });

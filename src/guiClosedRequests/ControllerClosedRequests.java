...
/*******
 * <p> Title: ControllerClosedRequests Class. </p>
 *
 * <p> Description: The Java/FX-based Closed Requests Page controller. Handles button
 * actions defined by ViewClosedRequests. This page is a placeholder; actions for browsing
 * closed request history and reopening requests will be added in a future phase.
 *
...
public class ControllerClosedRequests {
	 ...
	 */
	public ControllerClosedRequests() {
	}
	...
	protected static void performLogout() {
		guiUserLogin.ViewUserLogin.displayUserLogin(ViewClosedRequests.theStage);
	}
